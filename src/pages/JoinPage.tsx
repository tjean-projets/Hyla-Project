...
export default function JoinPage() {
  ...
  async function loadInviter() {
    ...
    setInviterName(profile.full_name || 'Un utilisateur');
    setInviterUserId(profile.id);
    setLoading(false);
  }
  ...
  const inputClass =
    'w-full rounded-xl border border-gray-200 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-400 bg-white';
